  ...
  return (
    <div>
      ...
      <div className="w-[90%] flex justify-center m-auto flex-wrap pt-10">
        <Office_Card address="159, Transport Center, Punjabi Bagh, New Delhi-110035" />
        <Office_Card address="1301/1302,Building E Trade Link,A-wing , Kamala City , S.B Marg, Mumbai 400013 Maharashtra" />
        <Office_Card address="No.3, 2nd Floor, Srinidhi Envoy, 4th 'C' Cross, 2nd Main, Kasturinagar, Banaswadi, Bangalore -560043, India" />
        <Office_Card address="Office no 208, 2nd Floor, Ashoka Mall, Bund Garden Road Survey Number 49/A, Pune - 411001" />
        <Office_Card address="Ground Floor, 113, Delhi Kolkata Highway, Ashok Grah Kolkata North Twenty Four Parganas, West Bengal, 700108" />
        <Office_Card address="Office No. B-705 , Sivanata One, Opposite Bank of Baroda, Paldi, Ahmedabad - 380007" />
        <Office_Card address="No. 17, Noble 1st street, Next to Engine Valves Ltd. Alandur Chennai - 600016" />
        <Office_Card address="Room 301-302, Building 6, No.1080, Changyang Road, Shanghai, China Post Code: 200092" />
      </div>
