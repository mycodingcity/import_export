  ...
  return (
    <div>
      ...
      <div className="bg-slate-500  ">
        <div className="flex items-flex-start justify-evenly text-2xl font-bold text-white  ">
          <div className="py-6 px-3 bg-[#091242] w-[350px] ">
            <img src={logo} alt="" />
          </div>
          <div>
          ...
          <div>
            <div className="py-5 bg-slate-500 px-3 w-[350px]">Subscribe</div>
          </div>
        </div>
      </div>
            ...
            <div className="flex">
              <div className="py-4 text-white">
                <div className="flex  items-center gap-2 pb-3">
                  <img src={Icon_7} alt="" />
                  <p className="font-medium	 items-center ">Email<br /><span className="font-normal">codingcity@gmail.com</span></p>
                </div>
                <div className="flex  items-center gap-2 pb-3">
                  <img src={Icon_8} alt="" />
                  <p className="font-medium	 items-center ">Call Us<br /><span className="font-normal">+91-807609XXXX</span></p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="flex justify-around py-3 bg-[#091242] text-white border-t-2">
